...
char* data_20 = "qwerqwerqwerqwerqweqwerqwerqwerqwerqweqwerqwerqwerqwerqweqwerqwerqwerqwerqweqwerqwerqwerqwerqweqwerqwerqwerqwerqweqwerqwerqwerqwerqweqwerqwerqwerqwerqweqwerqwerqwerqwerqweqwerqwerqwerqwerqwe";
char recieved_data[20];
String recieved_str_data;
...
void data_recieve_callback(const uint8_t *mac_addr, const uint8_t *incomingData, int len){
  recieved_str_data = (char*)incomingData;
  Serial.println("Data: ");
  Serial.println(recieved_str_data);
}
...
void loop(){
  esp_now_send(reciever_Addr,(uint8_t*)data_20,200);
