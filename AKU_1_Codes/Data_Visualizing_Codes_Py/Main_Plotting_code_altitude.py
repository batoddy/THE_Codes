...
axes[0].plot(df[x], df["Altitude"], label="Altitude", color="blue")
#axes[0].grid(True)
...
axes[1].plot(df[x], df["Velocity"], label="Velocity", color="blue")
#axes[1].grid(True)
...
axes[2].plot(df[x], df["Pressure"], label="Pressure", color="blue")
#axes[2].grid(True)
...
# plt.savefig("AKU1_flight_Data_SD_Card_Altitude.png")
plt.show()
